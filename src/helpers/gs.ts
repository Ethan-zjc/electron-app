...
import { gsInfo } from '../mini.config';
...
const fomateQueryPrams = (params: any) => {
...
const getGsContent = (miniId: string, appSecret: string, kkst: string, queryParams: any) => {
